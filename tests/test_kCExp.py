...
class test_kCExp(unittest.TestCase):
    ...
    def test_undirected(self):
        ...
        self.assertTrue(np.all(trade>=0),"weight adjacency matrix must be non-negative")
        G.solver(model="k-CExp",exogenous_variables=exog,selection_variables=exog)
        print("norm",G.norm)
