...
def example_data_and_settings_undirected():
    ...
    tradeflow_2007 = np.ceil(tradeflow_2007).astype(np.float64)
...
class test_kCGeom(unittest.TestCase):
    ...
    def test_undirected(self):
        ...
        G.solver(model="k-CGeom",exogenous_variables=exog,selection_variables=exog)
