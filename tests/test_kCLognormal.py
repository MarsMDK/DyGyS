...
class test_kCLognormal(unittest.TestCase):
    ...
    def test_undirected(self):
        ...
        G.solver(model="k-CLognormal",exogenous_variables=exog,selection_variables=exog)
        ...
        # for n_ens in range(G.w_ensemble_matrix.shape[1]):
        #     for ob in range (G.w_ensemble_matrix.shape[0]):
        #         print(G.w_ensemble_matrix[ob,n_ens])
        #     print('------------------')
